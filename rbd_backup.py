    ...
    try:
        ...
        if is_rbd_list_from_command_line == True:
            ...
            if cfg.backup_list_from_openstack_yaml_file == 'True':
                ...
                rbd_backup_list.read_openstack_yaml(cfg.openstack_yaml_file_path,cfg.openstack_yaml_section)
                if rbd_backup_list.set_cinder_client(distribution=cfg.openstack_distribution,api_version=cfg.api_version):
